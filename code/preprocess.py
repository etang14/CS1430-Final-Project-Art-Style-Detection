...
# One-time code used for reformatting and obtaining all images needed for classification.
# 105 artists total
# ----------------------------------------------------------------- 5011
# get_data_by_style(
#     [
...
#     "henri-le-fauconnier", "pyotr-konchalovsky", "amadeo-de-souza-cardoso", "bela-kadar",  "georg-pauli", 
#     "louis-marcoussis", "marevna-marie-vorobieff",
#     "ossip-zadkine", "roger-de-la-fresnaye", "albert-gleizes", 
...
# ----------------------------------------------------------------- 2504
# get_data_by_style([ 
#     "francisco-goya", "thomas-lawrence", "charles-turner", "orest-kiprensky", "william-turner"
